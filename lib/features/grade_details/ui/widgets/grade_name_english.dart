...
class GradeNameEnglish extends StatelessWidget {
  String? errorName;
  GradeNameEnglish({required this.errorName,super.key});


  @override
  Widget build(BuildContext context) {
    return AppTextFormField(
      hintText: "Enter Grade name in English",
      isPhoneNumber: true,
      errorText: errorName,
      hintStyle: TextStyles.font14BlackColor13Weight400,
      keyboardType: TextInputType.emailAddress,
      controller: GradeDetailsCubit.get(context).addEnController,
      validator: (value) {
        if (value!.isEmpty) {
